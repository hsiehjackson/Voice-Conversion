    ...
    def train(self, n_iterations):
        for iteration in range(n_iterations):
            ...
            if iteration % self.args.summary_steps == 0:
                self.logger.scalars_summary(f'{self.args.tag}/pd_mbv_train', meta, iteration)

            loss_rec = meta['loss_rec']
            print(f'MBV:[{iteration + 1}/{n_iterations}], loss_rec={loss_rec:.3f}', end='\r')
