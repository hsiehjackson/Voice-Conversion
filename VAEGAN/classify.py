...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_dir', '-d', default='/home/mlpjb04/Voice_Conversion/h5py-LibriTTS/AdaVAE')
    parser.add_argument('-load_model_path', default='model/')
    parser.add_argument('-output_model_path', default='model_Classifier_80/')
